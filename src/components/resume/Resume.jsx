            ...
            <div className=" relative">
              ...
              <div className=" flex flex-col gap-1 sm:gap-1 border-2 border-yellow-400 shadow-[0px_0px_16px_1px_rgba(0,0,0,0.1)] p-3 rounded-lg">
                ...
                <p className=" text-[.9rem] text-justify break-words text-gray-500">
                  ...
                  and developed various web application as per client demands. Learned tools like PostgreSQL, React Native,
                  Next Js used for web as well as andriod app development. I have resolved technical issues and maintained 
                  the application, ensuring a high level of customer satisfaction .
                </p>
              </div>
            </div>
          </fieldset>
